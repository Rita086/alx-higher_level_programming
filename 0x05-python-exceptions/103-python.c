...
#include <stdio.h>
/**
 * print_python_float - gives data information of the PyFloatObject
 * @p: the PyObject
 */
...
/**
 * print_python_bytes - gives data information of the PyBytesObject
 * @p: the PyObject
 */
void print_python_bytes(PyObject *p)
{
	Py_ssize_t size = 0, b = 0;
	char *string = NULL;
